...
class ImageView(APIView):
    def post(self, request, format=None):
        ...
        if serializer.is_valid():
            ...
            image_path = "/var/www/html/dev/Hackathons/Srm-7.0/final/image_api/media/images/" + image_name 
            model  = load_model("/var/www/html/dev/Hackathons/Srm-7.0/final/image_api/models/lr_model_satellite_wildfires.h5",compile=False)
